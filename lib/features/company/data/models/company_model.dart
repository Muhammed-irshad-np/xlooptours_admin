...
class CompanyModel extends CompanyEntity {
  const CompanyModel({
    ...
    super.email,
    super.country,
    super.vatRegisteredInKSA = false,
    super.taxRegistrationNumber,
    super.city,
    super.streetAddress,
    super.buildingNumber,
    super.district,
    super.addressAdditionalNumber,
    super.postalCode,
    super.usesCaseCode = false,
    super.caseCodeLabel,
    super.caseCodes = const [],
    super.status = 'ACTIVE',
  ...
  factory CompanyModel.fromEntity(CompanyEntity entity) {
    return CompanyModel(
      ...
      vatRegisteredInKSA: entity.vatRegisteredInKSA,
      taxRegistrationNumber: entity.taxRegistrationNumber,
      city: entity.city,
      streetAddress: entity.streetAddress,
      buildingNumber: entity.buildingNumber,
      district: entity.district,
      addressAdditionalNumber: entity.addressAdditionalNumber,
      postalCode: entity.postalCode,
      usesCaseCode: entity.usesCaseCode,
      caseCodeLabel: entity.caseCodeLabel,
      caseCodes: entity.caseCodes,
